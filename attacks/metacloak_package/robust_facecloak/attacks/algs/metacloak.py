...
def main(args):
    ...
    def save_image(perturbed_data, id_stamp):
        ...
        for img_pixel, img_name in zip(noised_imgs, img_names):
            save_path = os.path.join(f'../../../dataset/{args.dataset_name}/{args.instance_name}_metacloak', f"noisy_{img_name}")
            os.makedirs(f'../../../dataset/{args.dataset_name}/{args.instance_name}_metacloak', exist_ok=True)
            Image.fromarray(
