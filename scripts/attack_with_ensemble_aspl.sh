...
sd15_path="runwayml/stable-diffusion-v1-5"
sd21_path="stabilityai/stable-diffusion-2-1-base"
ref_model_path="stabilityai/stable-diffusion-2-1-base, runwayml/stable-diffusion-v1-5, CompVis/stable-diffusion-v1-4"
