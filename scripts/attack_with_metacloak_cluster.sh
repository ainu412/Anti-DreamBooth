...
#source activate anti-dreambooth

for name in amm
do
  export instance_name=$name
  export dataset_name=myfriends # for the Cele, change it to CelebA-HQ-clean

  #### Variables that you should set before running the script
  export PYTHONPATH="${PYTHONPATH}:/home/z/ziguo/Anti-Dreambooth-Linux"
  export ADB_PROJECT_ROOT="/home/z/ziguo/Anti-Dreambooth-Linux"
  # setting the GPU id
