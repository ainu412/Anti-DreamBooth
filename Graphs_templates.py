...
if __name__ == '__main__':
    ...
    # Dummy data for demonstration
    psnr_std = [0.5, 0.4, 0.6, 0.3, 0.5]  # Example standard deviations for error bars

    # Create the improved bar chart
    plt.figure(figsize=(10, 6))
    bar_width = 0.6  # Adjusted bar width
    bars = plt.bar(methods, psnr_values, yerr=psnr_std, capsize=5, color='steelblue', edgecolor='black', width=bar_width)
